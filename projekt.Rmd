...
Spodnji graf prikazuje primerjavo plač zgolj nekaterih evropskih držav. Izbrala sem le tiste, ki imajo podobne plače kot v Sloveniji in Avstrijo ter Nemčijo. Avstrijo sem izbrala zato, ker je veliko Slovencev tam zaposlenih, še posebej tistih, ki živijo na koroškem. To je tudi razlog, da so v tej regiji plače v višjo kot v večina ostalih regijah (razvidno je iz zgornjega zemljevida).
...
```
Spodnji graf prikazuje plače do leta 2020 v Sloveniji. Vidim, da pride do velikega odstopanja, saj model ne more napovedati krize, še posebej ne takšne vrste krize, ki je bila leta 2020

```{r napoved1, fig.align='center'}
print(graf.napoved1)
```
